...
<?php if(isset($_SESSION['admin_account_exists']) && !$_SESSION['admin_account_exists']){ ?>
	...
	<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
		<fieldset>
			...
			<input class="btn btn-primary btn-block" type="submit" name="submit" value="Admin Sign up" />
		</fieldset>
	</form>
